...
print('n_features: %d, %d, %d' % (n_features, h, w))
...
print('X_train_pca: ', X_train_pca.shape[1])
print('X_test_pca: ', X_test_pca.shape[1])
print('done in %0.3fs' % (time() - t0))
...
def plot_gallery(images, titles, h, w, n_row=3, n_col=4):
    """Helper function to plot a gallery of partraits"""
